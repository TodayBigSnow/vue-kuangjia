        ...
        <div class="header-box">
          ...
          <div class="right">
            <ul>
              ...
              <li>
                <a href="http://www.gangkou56.com/tms_sys/" target="view_window">管车入口</a>
              </li>
              <li @click="goRouter('phoneMe')">联系我们</li>
              <li @click="goRouter('login')">{{$store.state.loginObj.name}}</li>
              <li @click="goRouter('Order')">
                下单
      ...
      <div class="w">
        ...
        <div class="cont">
          ...
          <div>
            <dl>
              <dd>
                <a href="http://www.gangkou56.com/" class="hrefA" target="_blank">技术支持</a>
              </dd>
              <dd>
                <a href="http://www.gangkou56.com/" class="hrefA" target="_blank">承集信息科技（上海）有限公司</a>
              </dd>
              <dd>
                <a href="http://www.gangkou56.com/" class="hrefA" target="_blank">驮鸟物流</a>
              </dd>
            </dl>
          </div>
        </div>
